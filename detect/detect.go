...
func DetectVulnerabilityCustom(wg *sync.WaitGroup, host string, payload string, status int, silent string, paths string, pattern string, out string) {
...
func DetectVulnerabilityWithTemplate(wg *sync.WaitGroup, payload string, templates string, host string, config yamlconf.YamlConfig, silent string, out string) {
